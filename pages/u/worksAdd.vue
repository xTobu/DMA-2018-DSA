<template>
    <div class="userWrapper">
        <p>請填寫以下作品詳細資料。在2018年9月20日報名截止前，您隨時可以保存，且可隨時返回該頁面完成參賽資料的填寫。 </p>
        <div class="wrap-form">
            <h5>作品基本資料</h5>
            <div class="wrap-data">
        ...
        <div class="wrap-form">
            ...
            <ul>
                ...
                <li>若您尚未下載報名表及作品說明範本的話，請由
                    <a href="/2018/RegistrationDocument.zip"> 此處下載</a>
                </li>
                <li>影片連結及圖片檔案為非必須選項。但是製作良好的作品介紹影片case film，有助於評審更快速及深入的理解你對作品的想法。<br>上傳作品說明影片連結時，請先上傳至youtube，長度限於3分鐘內，並將影片設定為「非公開」。大陸地區請上傳至騰訊視頻。</li>
